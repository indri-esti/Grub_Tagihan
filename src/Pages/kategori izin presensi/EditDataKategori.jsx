  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Berhasil!",
        text: "Kategori izin berhasil diperbarui!",
        showConfirmButton: false,
        timer: 2000,
      });
      navigate("/kategoriizin");
    } catch (error) {
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            type="text"
            name="nama"
            placeholder="Contoh: Izin / Sakit / Dispensasi"
            value={formData.nama}
...
export default EditDataKategori;
